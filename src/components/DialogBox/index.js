...
function DialogBox(props) {
    ...
    return (
        <Grid container direction='row'>
            <img alt='headsUpIcon' src={headsUpIcon} style={{height: 30, width: 11, paddingLeft: 15}}/> 
            <Typography className={classes.headsUp}>Heads up!</Typography>
            <Grid container direction='row' className={classes.box} justify='flex-end'>
                <Typography className={classes.boxText}>Do you wish to proceed with publishing your story for everyone?</Typography>
